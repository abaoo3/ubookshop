...
export const Block = props => {
    ...
    return <c-c style={{
        ...
        <f-cc style={{ padding: "5px 8px", width: "100%", height:45
            , direction:"ltr"
         }}>
        ...
        <f-csb style={{ width: "100%", padding: "5px 0" }}>
            ...
            <c-x style={{direction:"ltr", margin:"0 10px"}}>
                <f-12> <del>{(Number(props.book.price) as number).toLocaleString("fa-IR")} تومان</del> </f-12>
